...
init=function(
  ...
  n=switch(docx,                          # sample sizes
           readme=c(20,100),effit=c(10,20,200)),
  ...
  mean.true=switch(docx,readme=0.3,effit=c(0.3,0.7)),
  sd.true=0.1,
  mean.false=0,
  sd.false=0.05,
  ## fiddle
  n.fdl=c(10,20,40,80,100,200),
  d0.fdl=d0,
  prop.true.fdl=c(0.25,0.50,0.75,0.8,0.9,1),
  mean.true.fdl=seq(0.7,2,by=0.1),
  sd.true.fdl=seq(0.1,1,by=0.1),
  mean.false.fdl=mean.false,
  sd.false.fdl=sd.false,
  id.fdl=NULL,
