...
init=function(
  ...
  d0=switch(docx,readme=0.5,efiit=0.5),   # center of desired range
  tol=switch(docx,readme=1e-3,efiit=1e-3),# tolerance around d0
  ...
  clean=switch(docx,readme=T,F),          # controls specific clean params
